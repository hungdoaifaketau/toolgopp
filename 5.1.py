...
\033[1;33m╠═══════════════════════════════════════════════╣                   
\033[1;33m║\033[1;34m▶ Telegram: \033[1;35m https://t.me/hunglaptrinh\033[1;33m         ║
\033[1;33m║\033[1;34m▶ Cầnhỗtrợ gì thì liên hệ telegram của mình nhé\033[1;33m║        
\033[1;33m║\033[1;34m▶ HãyĐểDelay Tầm 8s đến 12s Nhé                \033[1;33m║
\033[1;33m╚═══════════════════════════════════════════════╝
\033[1;32m-------------------------------------------------"""
...
class ApiZefoy:
    ...
    def get_captcha(self):
        ...
        try:
            ...
            print(f'{vua}Đang giải capcha...')
            return False
        except Exception as e:
            print(f"{vua}{do}Không thể giải captcha: {e}")
            time.sleep(2)
            self.get_captcha()
    ...
    def giai_captcha(self):
        ...
        if 'Enter Video URL' in rq:
            ...
            print(f"{vua}Giải capcha thành công: {giai_captcha}")
    ...
    def get_table(self):
        ...
        while True:
            if len(self.get_status_services()[0])>1:
                ...
                print(f'{vua}{do}Không có sever nào hoạt động. Thử lại...')
                self.giai_captcha()
                time.sleep(3)
        for service in self.services:
            table.add_row([f"{trang}{Fore.CYAN}{i}{Fore.RESET}", service, f"{Fore.GREEN if 'ago updated' in self.services[service] else Fore.RED}{self.services[service]}{Fore.RESET}"])
            i+=1
        ...
        while True:
            ...
            if self.service > len(self.services_status)-1 or self.service < 0:
                print(f"{vua}{do}Bạn nhập sai số!")
            else:
